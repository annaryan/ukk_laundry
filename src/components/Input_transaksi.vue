            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" placeholder="Tanggal" v-model="tanggal">
                  </div>
                  <div class="form-group">
...
module.exports = {
  ...
  methods: {
    ...
    getPaketDropdown: function(){
        ...
        .then(response => {
            ...
            json_paket.forEach(element => {
                list_paket.push({value: element.id_paket, text: element.jenis_paket+" - "+element.harga})
            });
    ...
    Save : function(){
      let conf = { headers: { "Authorization" : 'Bearer ' + this.key } };
      //get id user
      axios.get(base_url + "/user/login/check", conf)
      .then(response => {
